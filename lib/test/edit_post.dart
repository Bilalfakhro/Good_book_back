...
import 'package:good_book_back/test/PostService.dart';
import 'package:good_book_back/test/home.dart';
          ...
          child: ListView(
            children: <Widget>[
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: TextFormField(
                  initialValue: widget.post.Descreption,
                  decoration: InputDecoration(
                      labelText: "Post body",
                      border: OutlineInputBorder()
                  ),
                  onSaved: (val) => widget.post.Descreption = val,
                  validator: (val){
                    if(val.isEmpty){
